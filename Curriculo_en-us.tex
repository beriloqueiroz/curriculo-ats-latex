...
\section{Skills}
 {
  \fbox{\strut Java Springboot} \fbox{\strut Go\/Golang} \fbox{\strut Javascript} \fbox{\strut NodeJs} \fbox{\strut typescript} \fbox{\strut C\# .NET}
  \fbox{\strut HTML} \fbox{\strut CSS} \\
  \\
  \fbox{\strut MySQL} \fbox{\strut PostgreSQL} \fbox{\strut MongoDB} \\
  \\
  \fbox{\strut API Rest} \fbox{\strut Tests} \fbox{\strut gRPC} \fbox{\strut Microservices} \fbox{\strut Docker}\\
  \\
  \fbox{\strut SOLID} \fbox{\strut Clean Architecture} \fbox{\strut Git} \fbox{\strut DDD} \\
  \\
  \fbox{\strut Scrum} \fbox{\strut Kanban}\\
  \\
  \fbox{\strut Kubernetes} \fbox{\strut AWS Ec2 RDS} \fbox{\strut Google Cloud Run}\\
  \\
