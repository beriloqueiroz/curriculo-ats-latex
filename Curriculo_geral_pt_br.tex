...
\makecvtitle
\vspace*{-10mm}
\begin{center}\textbf{ Engenheiro de Mecatrônica | Engenheiro de Software}\end{center}
...
\section{Perfil}
 {
  Engenheiro de Mecatrônica e Engenheiro de Software com mais de 13 anos de experiência, atuando na
  interseção entre automação industrial/predial, desenvolvimento de software e gestão de negócios.
  Histórico comprovado de liderança e entrega de projetos de alta complexidade em automação (CLP, SDAI,
  supervisórios, redes industriais) e desenvolvimento de software (microserviços, cloud, arquitetura limpa).
  Experiência com gestão empresarial, empreendedorismo e consultoria de tecnologia. Orientado a resultados,
  com forte compromisso com inovação e melhoria contínua.
 }

\section{Habilidades Técnicas}
 {
  Desenvolvimento: \fbox{\strut Go\/Golang} \fbox{\strut Java Springboot} \fbox{\strut Python} \fbox{\strut Javascript} \fbox{\strut NodeJs} \fbox{\strut typescript} \fbox{\strut C\# .NET}
  \fbox{\strut HTML} \fbox{\strut CSS} \\
  \\
  Automação: \fbox{\strut CLP (Siemens, Schneider)} \fbox{\strut Elipse E3 / SCADA} \fbox{\strut SDAI} \fbox{\strut Profinet} \fbox{\strut Modbus}
  \fbox{\strut Controle PID} \fbox{\strut IHM Siemens} \fbox{\strut Ladder} \\
  \\
  Banco de dados: \fbox{\strut PostgreSQL} \fbox{\strut MySQL} \fbox{\strut SQL Server} \fbox{\strut MongoDB} \\
  \\
  Infraestrutura: \fbox{\strut Docker} \fbox{\strut Kubernetes} \fbox{\strut AWS Ec2 RDS} \fbox{\strut Terraform} \fbox{\strut Jenkins} \fbox{\strut Google Cloud Run}\\
  \\
  Arquitetura: \fbox{\strut SOLID} \fbox{\strut Clean Architecture} \fbox{\strut DDD} \fbox{\strut Microservices} \fbox{\strut API Rest} \fbox{\strut gRPC}\\
  \\
  Gestão: \fbox{\strut Scrum} \fbox{\strut Kanban} \fbox{\strut Gestão de Projetos} \fbox{\strut BI / Análise de Dados} \fbox{\strut Empreendedorismo}\\
 }
...
\section{Habilidades Comportamentais}
 {
  ...
  \\
  \fbox{\strut Análise de problemas} \fbox{\strut Visão de negócios} \fbox{\strut Liderança} \fbox{\strut Comprometimento}
 }

\section{Experiência Profissional}

\begin{samepage}
	\customcventry{04/2025 - Atual}{{\color{blue}\href{https://www.economatica.com/}{Economatica}}}%
	{Engenheiro de Software}{---}{---}{%
		\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
			\item Desenvolvimento de microserviços em Go na maior plataforma de análise de dados financeiros da América Latina.
			\item Atuação com AWS (RDS, EC2), Kubernetes, PostgreSQL, SQL Server, gRPC e API REST.
			\item Utilização de Python para ferramental e automação de processos internos.
			\item Terraform para provisionamento de infraestrutura e Jenkins para CI/CD.
		\end{itemize}
	}
\end{samepage}
\vspace{\baselineskip}
...
\begin{samepage}
	...
	{Desenvolvedor Backend Senior}{---}{---}{%
		\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
			\item Desenvolvimento Backend utilizando, Java 8, 17, 21, Spring, Spring Boot, Groovy.
			...
			\item Refatoração e reescrita dos meios de pagamentos e integração com vários gateways com melhoria de mais de 30\% de redução de erros no sonarcloud e logs de erros no rapid7.
		\end{itemize}
	}
\end{samepage}
\vspace{\baselineskip}
...
\begin{samepage}
	...
	\begin{itemize}[itemsep=0cm, leftmargin=0.6cm, label={\textbullet}]
		...
		\item Desenvolvimento do site: Next.js (React.js, ESLint, Husky, Staged-lint, stylelint, SCSS) para \underline{bid.log.br}, integrando com roteirizador e rastreamento de encomendas. {\color{blue}\href{https://github.com/beriloqueiroz/bid-site}{github}}
		\item Desenvolvimento do site WordPress: {\color{blue}\href{psicologarichellysousa.com.br}{psicologarichellysousa.com.br}}
		\item Desenvolvimento do site institucional: Next.js (React.js, Tailwind, CTA WhatsApp) para {\color{blue}\href{https://casanaturalesaudeebeleza.com.br}{casanaturalesaudeebeleza.com.br}}
		\item Desenvolvimento do site institucional: Next.js (serviços SDAI, combate a incêndio, automação) para {\color{blue}\href{https://saytfire.com.br}{saytfire.com.br}}
		\item Desenvolvimento do site com catálogo de produtos: Next.js para {\color{blue}\href{https://revelaron.com.br}{revelaron.com.br}}
		\item Automação industrial -- CAG HalexiStar (indústria farmacêutica): CLP Siemens S7-1200, remotas ET-200SP, Profinet, controle PID de pressão e temperatura, inversores via Profinet. Parceria com Rx Engenharia.
		\item BeMusic: Protótipo em Python que transforma vídeos do YouTube em cifra sincronizada com a letra (WhisperX). {\color{blue}\href{https://github.com/beriloqueiroz/bemusic}{github}}
	\end{itemize}
\end{samepage}
\vspace{\baselineskip}
...
\fancyfoot[C]{\color{blue}{\href{https://github.com/beriloqueiroz/curriculo-ats-latex}{LaTeX by Berilo Queiroz}}}
