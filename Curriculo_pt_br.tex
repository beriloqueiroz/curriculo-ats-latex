...
\section{Habilidades Técnicas}
 {
  Linguagens: \fbox{\strut Go\/Golang} \fbox{\strut Java Springboot} \fbox{\strut Python} \fbox{\strut Javascript} \fbox{\strut NodeJs} \fbox{\strut typescript} \fbox{\strut C\# .NET}
  ...
  \\
  Tecnologias: \fbox{\strut API Rest} \fbox{\strut gRPC} \fbox{\strut Tests} \fbox{\strut Docker}\\
  \\
  ...
  \\
  Ferramentas/Nuvem: \fbox{\strut Git} \fbox{\strut Kubernetes} \fbox{\strut AWS Ec2 RDS} \fbox{\strut Terraform} \fbox{\strut Jenkins} \fbox{\strut Google Cloud Run}\\
 }
